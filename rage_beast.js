...
if ( args[ 0 ] === "on" ) {
	...
	let claws = {
		...
		system: {
			"description": {
				"value": "<p><strong>Claws.</strong> Each of your hands transforms into a claw, which you can use as a weapon if it’s empty. It deals 1d6 + 4 slashing damage on a hit. Once on each of your turns when you attack with a claw using the Attack action, you can make one additional claw attack as part of the same action.</p><p></p>",
			},
			"quantity": 1,
			"equipped": true,
			"identified": true,
	...
	let tail = {
		...
		system: {
			"description": {
				"value": "<p><strong>Tail.</strong> You grow a lashing, spiny tail, which deals 1d8 + 4 piercing damage on a hit and has the reach property.</p>",
				"chat": "",
				"unidentified": ""
			},
			"quantity": 1,
	...
	let tailSwipe = {
		...
		system: {
			"description": {
				"value": "<p><strong>Tail Swipe.</strong> If a creature you can see within 10 feet of you hits you with an attack roll, you can use your reaction to swipe your tail and roll 1d8, applying a bonus to your AC equal to the number rolled, potentially causing the attack to miss you.</p>",
			},
			"quantity": 1,
			"equipped": true,
			"identified": true,
	...
	if ( subClass == "path-of-the-beast" ) {
		const buttonData = {
			buttons: [ {
				...
				{
					label: "<a title='Each of your hands transforms into a claw, which you can use as a weapon if it’s empty. It deals 1d6 slashing damage on a hit. Once on each of your turns when you attack with a claw using the Attack action, you can make one additional claw attack as part of the same action.' alt='Each of your hands transforms into a claw, which you can use as a weapon if it’s empty. It deals 1d6 slashing damage on a hit. Once on each of your turns when you attack with a claw using the Attack action, you can make one additional claw attack as part of the same action.'>Claws</a>",
					value: {
						msg: clawMsg,
						update: {
							embedded: {
